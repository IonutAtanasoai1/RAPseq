...
for (i in 1:length(Names)){
  ...
  colnames(Tables[[i]]) <- c("chr","Summit_start","Summit_end","start","end","strand","Count_rep1","Count_rep2","minuslog10pval_rep1","minuslog10pval_rep2","Rep1","Rep2","Halo","Input","minusInput_rep1","minusInput_rep2","minusInput_Halo","positive_fa","negative_fa","RPM_rep1","RPM_rep2","RPM_Halo","RPM_Input")
}
...
for(i in Names){
  ...
  Tables[[i]]$RPM_Halo[Tables[[i]]$RPM_Halo == 0] <- min(Tables[[i]][Tables[[i]]$RPM_Halo!=0,"RPM_Halo"])
  ...
  Tables[[i]]$FCHrpm_rep1 <- Tables[[i]]$RPM_rep1/Tables[[i]]$RPM_Halo 
  Tables[[i]]$FCHrpm_rep2 <- Tables[[i]]$RPM_rep2/Tables[[i]]$RPM_Halo
  ...
  #Tables[[i]] <- Tables[[i]][Tables[[i]]$FCHrpm_rep1 >= 2 & Tables[[i]]$FCHrpm_rep2 >= 2,]
