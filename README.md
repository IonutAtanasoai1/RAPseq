...
## Alignment
#### 1. Alignment (Reference Genome Alignment) -> E.hisat2_genome_alignment_uniq.mapped_rmdup.sh
...
## Peak Calling
#### 1. Peak Calling (Identification Of Candidate Genomic Coordinates) -> F.make_bedgraphs_and_find_candidate_coordinates.sh
